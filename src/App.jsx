Y��x-���jם��i��+��j[h��ܢ�������x�N�o+^����םimport { lazy, Suspense, useCallback, useEffect, useMemo, useRef, useState } from "react";
import {
  uid,
  today,
  contactLinks,
...
export default function App() {
  ...
  if (location.pathname.match(/^\/todogreen(?:\/|$)/))
    return (
      <Suspense fallback={<div className="loading">Carregando To Do Green...</div>}>
        <LogisticsVertical
          db={db}
          update={update}
          setToast={setToast}
