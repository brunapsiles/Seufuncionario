...
describe("inteligência e canais da conta", () => {
  it("prioriza procurement e sugere tarefa sem inventar contatos", () => {
    const result = assessAccount({ name: "Empresa logística", segment: "Transporte", crm: { contacts: [{ id: "1", name: "Fernanda", department: "Procurement", email: "fernanda@example.com" }] } });
