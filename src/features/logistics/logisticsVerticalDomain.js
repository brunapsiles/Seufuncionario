...
export const TODO_GREEN_PERMISSIONS = {
  owner: ["*"],
  admin: ["*"],
  lideranca_comercial: ["read", "deal:approve", "pricing:simulate", "proposal:create", "work:item:write", "goal:read", "goal:create", "goal:update", "goal:checkin", "goal:approve", "goal:close", "goal:manage-team", "goal:export"],
  vendedor: ["read", "pricing:simulate", "proposal:create", "work:item:write", "goal:read", "goal:checkin"],
...
export const TODO_GREEN_MODULE_CATALOG = [
  ...
  module("central-trabalho", "Central de Trabalho", "gestao", "/todogreen/central-trabalho", {
    icon: "ListTodo",
    order: 58,
    description: "Tarefas, reuniões, aprovações e rotinas em lista, Kanban e agenda.",
    permissions: ["read", "work:item:write"],
  }),
  module("comunicacoes", "Comunicação com clientes", "comercial", "/todogreen/comunicacoes", {
    icon: "MessageCircle",
    order: 22,
    description: "Contatos do CRM e histórico compartilhado de WhatsApp, e-mail, ligações, formulários e notas.",
  }),
  module("tarefas", "Tarefas", "gestao", "/todogreen/central-trabalho", { icon: "ListTodo", order: 60 }),
  module("agenda", "Agenda", "gestao", "/todogreen/central-trabalho", { icon: "CalendarDays", order: 60.1 }),
  module("reunioes", "Reuniões", "gestao", "/todogreen/central-trabalho", { icon: "Users", order: 60.2 }),
  ...
  module("notificacoes", "Notificações", "gestao", "/todogreen/comunicacoes", { icon: "Bell", order: 63 }),
  module("inbox", "Inbox", "gestao", "/todogreen/comunicacoes", { icon: "Inbox", order: 64 }),
  module("integracoes", "Integrações", "gestao", "/todogreen/integracoes", {
    icon: "Settings",
    order: 64.5,
    description: "Pesquisa web, comunicação, TMS Tracker, agenda e portal do cliente.",
    permissions: ["read", "integration:manage"],
  }),
