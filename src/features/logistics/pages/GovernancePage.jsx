...
export default function GovernancePage({ role, permissions = [], authHeaders, setToast }) {
  ...
  return (
    <section className="tdg-panel tdg-governance-page">
      <div className="tdg-section-head"><div><span className="tdg-kicker">GOVERNANÇA</span><h2>Permissões e trilha unificada</h2><p>O histórico abaixo vem das mutações reais da vertical, separado por espaço de trabalho.</p></div><strong>{role || "sem papel"}</strong></div>
