...
CREATE TABLE IF NOT EXISTS todogreen_ciot_integrations (
  ...
  connector_url_env_key TEXT NOT NULL DEFAULT 'TODOGREEN_ANTT_CIOT_CONNECTOR_URL',
  connector_token_env_key TEXT NOT NULL DEFAULT 'TODOGREEN_ANTT_CIOT_CONNECTOR_TOKEN',
